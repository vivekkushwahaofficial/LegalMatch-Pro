    ...
    useEffect(() => {
        const fetchLawyers = async () => {
            try {
                ...
                // Handle if backend returns null/undefined
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div>
                    ...
                    <p className="text-gray-500 font-medium">
                        Connect with verified legal professionals across the country.
                    </p>
                </div>
                ...
                <div className="relative max-w-md w-full">
                    ...
                    <input 
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-white border-2 border-gray-100 rounded-3xl focus:border-indigo-500 outline-none shadow-sm"
                        value={searchTerm}
            ...
            {loading ? (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {lawyers.length === 0 && (
                        <div className="col-span-full text-center py-20">
                            <p className="text-gray-400 font-medium">
                                No lawyers available (Backend returned empty data)
                            </p>
                        </div>
                    )}
                    ...
                    {filteredLawyers.map((lawyer, index) => (
                        <div key={lawyer.id || index}
                            className="bg-white rounded-[40px] border border-gray-100 p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group">
                    ...
                    {filteredLawyers.length === 0 && lawyers.length > 0 && (
                        <div className="col-span-full text-center py-20 bg-gray-50 rounded-[40px] border-2 border-dashed border-gray-200">
                            <p className="text-gray-400 font-medium">
                                No lawyers matched your search criteria.
                            </p>
                        </div>
                    )}
                </div>
