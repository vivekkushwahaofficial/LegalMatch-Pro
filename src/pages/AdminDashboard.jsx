...
const AdminDashboard = () => {
    ...
    const verificationQueue = [
        { id: 1, name: 'Alice Johnson', role: 'Lawyer', email: 'alice.j@example.com', submittedDate: '2024-03-10', status: 'Pending' },
        { id: 2, name: 'LegalAid Corps', role: 'NGO', email: 'info@legalaid.org', submittedDate: '2024-03-12', status: 'Pending' },
        { id: 3, name: 'Bob Smith', role: 'Lawyer', email: 'bob.s@example.com', submittedDate: '2024-03-05', status: 'Approved' },
        { id: 4, name: 'Community Justice', role: 'NGO', email: 'contact@cjustice.org', submittedDate: '2024-03-08', status: 'Rejected' },
        { id: 5, name: 'Charlie Brown', role: 'Lawyer', email: 'charlie.b@example.com', submittedDate: '2024-03-15', status: 'Pending' },
    ];
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {verificationQueue.map((user) => (
                                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">{user.submittedDate}</td>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            {user.status === 'Pending' ? (
                                                <div className="flex justify-end gap-2">
                                                    <button className="flex items-center gap-1 px-3 py-1.5 bg-slate-900 text-white rounded-md text-xs font-medium hover:bg-slate-800 transition-colors">
                                                        <CheckCircle size={14} /> Approve
                                                    </button>
                                                    <button className="flex items-center gap-1 px-3 py-1.5 bg-red-500 text-white rounded-md text-xs font-medium hover:bg-red-600 transition-colors">
